...
const SOCIAL_LINKS = [
  { href: "https://www.facebook.com/profile.php?id=61588547045586", icon: <FaFacebookF className="text-blue-600 text-lg md:text-2xl" /> },
  { href: "https://www.instagram.com/iift.official/", icon: <FaInstagramSquare className="text-pink-600 text-lg md:text-2xl" /> },
  { href: "https://www.youtube.com/@IIFT_Academy", icon: <FaYoutube className="text-red-600 text-lg md:text-2xl" /> },
  { href: "", icon: <FaLinkedin className="text-blue-800 text-lg md:text-2xl" /> },
  { href: "https://x.com/IIFT367437", icon: <FaXTwitter className="text-black text-lg md:text-2xl" /> },
  { href: "https://mail.google.com/mail/?view=cm&fs=1&to=iioft.education@gmail.com&su=Inquiry&body=Hello%20IIOFT%20Team", icon: <IoIosMailUnread className="text-yellow-500 text-lg md:text-2xl" /> },
      ...
      <div className="bg-blue-600 flex flex-col lg:flex-row justify-between items-start px-6 md:px-12 lg:px-32 py-12 gap-10 text-white">
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <p className="flex items-center gap-2"><FaEnvelope /> iioft.education@gmail.com</p>
